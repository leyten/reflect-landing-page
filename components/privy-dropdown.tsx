  ...
  if (!ready || !walletsReady) {
    return (
      <div className="fixed-width-container">
        <Button
          disabled
          className="w-[140px] md:w-[160px] bg-black text-white hover:bg-black focus:bg-black active:bg-black rounded-lg px-3 md:px-4 py-2 text-xs md:text-sm font-medium"
        >
          Loading...
        </Button>
      </div>
    ...
    <div className="fixed-width-container">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button className="w-[140px] md:w-[160px] bg-black text-white hover:bg-black focus:bg-black active:bg-black rounded-lg px-3 md:px-4 py-2 text-xs md:text-sm font-medium focus:outline-none">
            <div className="flex justify-between items-center w-full">
              <div className="flex items-center">
                ...
                <span className="sm:hidden">
                  {primaryWallet ? formatAddress(primaryWallet.address).slice(0, 6) : "Wallet"}
                </span>
              </div>
